        ...
        <div class="home-content">
            ...
            <div class="form-login">
                <form action="kategori-proses.php" method="post">
                    ...
                    <input class="input" type="text" name="categories" id="categories" value="<?php echo $data['category']; ?>" />
                    <label for="price">Price</label>
                    <input class="input" type="text" name="price" id="price" value="<?php echo $data['price']; ?>" />
